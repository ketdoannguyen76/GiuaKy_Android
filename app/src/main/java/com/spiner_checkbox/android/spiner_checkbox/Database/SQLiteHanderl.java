...
public class SQLiteHanderl extends SQLiteOpenHelper {
    ...
    public void themsv(String id, String name,String sex,String birthday){
        SQLiteDatabase db =this.getWritableDatabase();
    ...
    public void updateDataList(String ma,String id,String name,String sex,String birthday){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
